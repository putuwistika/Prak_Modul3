...
echo "${BRed}=======================================================================================================================${Color_Off}"
echo " "
echo "                              ${BBlue} ASISTEN PRAKTIKUM MPCN I 2023 BERSAMA KALIAN ${Color_Off}"
echo " "
echo " ${BCyan}                              *******************************************"
...
wget --load-cookies /tmp/cookies.txt "https://drive.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://drive.google.com/uc?export=download&id=1_TgEodfEOXyzkoTdAPeY4woZqpozcS97' -O- | sed -rn 's/.confirm=([0-9A-Za-z]+)._/\1\n/p')&id=1_TgEodfEOXyzkoTdAPeY4woZqpozcS97" -O MPCN_Modul3.zip -q --show-progress
